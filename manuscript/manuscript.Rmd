...
The **vazul** package is open source and distributed via CRAN and GitHub  (\url{https://github.com/nthun/vazul}). All analyses reported here were conducted using version 1.0.0.
