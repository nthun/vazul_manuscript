...
The \textbf{vazul} package is open source and distributed via CRAN and GitHub (\url{https://github.com/nthun/vazul}). All analyses reported here were conducted using version 1.0.0.
...
The \textbf{vazul} package includes two research datasets for demonstration and practice. The \texttt{marp} dataset contains cross-national survey data on religiosity \citep{MARP2022discussion}, while the \texttt{williams} dataset contains experimental data from a stereotyping study \citep{Sarafoglou2025-fr}.
